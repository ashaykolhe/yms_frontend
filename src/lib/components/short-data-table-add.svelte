...
<Dialog.Root bind:open={isOpen}>
	...
	<Dialog.Content class="min-w-400">
		<form action="?/addNewShortVideo" method="POST" use:enhance>
			<Dialog.Header>
				<Dialog.Title>Add New</Dialog.Title>
				<Dialog.Description>Add New Short Video</Dialog.Description>
			</Dialog.Header>
			...
			<div class="-mb-4 flex min-h-180 flex-col gap-6">
				<Tabs.Root bind:value={bindtitle}>
					...
					<Tabs.Content value="titledescriptionkeywords">
						...
						<div class="grid gap-3">
							<NativeSelect.Root class="w-390" name="domain">
						...
						<div class="grid gap-3">
							<NativeSelect.Root class="w-390" name="status">
